...
const SITE = {
    ...
    roleUrl: "http://jjust.me",
    intro:
        "I'm a backend engineer with experience building and maintaining production web applications and REST APIs — mainly in Java, Spring Boot, and PostgreSQL. This site is where I write about backend engineering and system design, and show the projects I've built. Check out the ",
...
const SKILLS = [
    { category: "Languages", items: ["Java (8, 17, 21)", "SQL", "JavaScript", "TypeScript"] },
    { category: "Backend", items: ["Spring Boot", "Spring Security", "Spring Data JPA", "Jersey", "REST APIs", "Microservices", "Node.js"] },
    { category: "Databases", items: ["PostgreSQL", "MySQL", "MongoDB", "Redis"] },
    { category: "Security", items: ["JWT", "OAuth2", "OIDC", "Keycloak", "RBAC"] },
    { category: "Messaging", items: ["Apache Kafka", "RabbitMQ"] },
    { category: "DevOps & Tools", items: ["Docker", "Nginx", "Linux (Fedora)", "Git", "Maven", "Postman", "IntelliJ IDEA"] },
];
...
const CONTENT_SCRIPTS = [
    ...CONTENT_FILES.posts.map((file) => new URL(`posts/${file}`, CONTENT_BASE).href),
    ...CONTENT_FILES.projects.map((file) => new URL(`projects/${file}`, CONTENT_BASE).href),
];
...
const ABOUT = {
    ...
    paragraphs: [
        ...
        `Outside of my day job I like building distributed systems projects to go deeper on the tools I use at work — see the <a href="index.html">projects</a> below for a couple of examples.`,
    ],
