...
const ICONS = {
    ...
    x: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817-5.963 6.817H1.684l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z"/></svg>`,
    ...
    mastodon: `<svg viewBox="0 0 24 24" fill="currentColor" aria-label="Mastodon"><path d="M23.193 7.14c0-5.19-3.4-6.73-3.4-6.73C18.08-.4 12.03-.65 12.03-.65h-.05S5.93-.4 4.22.41c0 0-3.4 1.54-3.4 6.73 0 1.19-.02 2.61.02 4.17.14 5.25 1.05 10.43 6.35 11.72 2.43.59 4.52.71 6.2.5 3.05-.38 4.45-2.31 4.45-2.31l-.09-1.98s-2.04.64-4.33.8c-2.27.16-4.67-.23-5.04-2.83a5.76 5.76 0 0 1-.05-.73s2.23.54 5.06.67c1.73.08 3.35-.1 5-.3 3.16-.38 5.91-2.34 6.26-4.14.55-2.84.51-6.93.51-6.93ZM19.1 13.6h-2.54V7.37c0-1.31-.55-1.98-1.66-1.98-1.22 0-1.83.79-1.83 2.35v3.41h-2.52V7.74c0-1.56-.61-2.35-1.83-2.35-1.11 0-1.66.67-1.66 1.98v6.23H4.52V7.18c0-1.31.34-2.35 1.03-3.12.71-.77 1.64-1.16 2.79-1.16 1.34 0 2.36.51 3.04 1.53l.65 1.09.65-1.09c.68-1.02 1.7-1.53 3.04-1.53 1.15 0 2.08.39 2.79 1.16.69.77 1.03 1.81 1.03 3.12v6.42Z"/></svg>`,
